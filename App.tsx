...
const App: React.FC = () => {
  ...
  const handleGarmentSelect = useCallback(async (garmentFile: File, garmentInfo: WardrobeItem) => {
    ...
    try {
      ...
      // Explicitly call getFriendlyErrorMessage and store its result in a variable
      // before passing to setError to avoid potential type inference issues.
      const errorMessage = getFriendlyErrorMessage(err, 'Falha ao aplicar a peça de roupa');
  ...
  const handlePoseSelect = useCallback(async (newIndex: number) => {
    ...
    try {
      ...
      // The getFriendlyErrorMessage function handles this safely, but we make the
      // conversion explicit to potentially resolve type inference issues.
      const errorMessage = getFriendlyErrorMessage(err, 'Falha ao mudar a pose');
      setError(errorMessage);
